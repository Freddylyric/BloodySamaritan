...
import ke.co.freddylyric.bloodysamaritan.adapters.UserAdapter;
...
// open nav bar
    ...
    //fetch donors data from database
    ...
    //fetch recipients data from database
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.compatible:
                Intent intent12 = new Intent(MainActivity.this, CategorySelectedActivity.class);
                intent12.putExtra("group", "Compatible");
